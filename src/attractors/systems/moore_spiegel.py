...
@SystemRegistry.register(
    ...
    reference='Moore, D. W., & Spiegel, E. A. (1966). "A thermally excited nonlinear oscillator," The Astrophysical Journal, 143, 871-887.',
    plot_lims={"xlim": (-10.0, 10.0), "ylim": (-20.0, 20.0), "zlim": (-250.0, 250.0)},
)
def moore_spiegel(state: StateVector, params: ParamVector) -> StateVector:
