...
def animate_simulation():
    ...
    # attractor_vects = [RK(r, 'lorenz', beta=8/3, sigma=5, rho=28) for r in initial_r_states]
    ...
    # attractor_vects = [RK(r, 'rossler', a=0.1, b=0.1, c=14) for r in initial_r_states]
    # for vect in attractor_vects:
    #     vect.RK4(0, 150, 8000)
    ...
    # attractor_vects = [RK(r, 'chen_celikovsky', a=36, b=3, c=27) for r in initial_r_states]
    # for vect in attractor_vects:
    #     vect.RK4(0, 100, 40000)
